...
#Joining reads
	...
	qiime_results=/scratch/ps163/Dr_Carolina/Project_Impact/qiime2/qiime_results/
	#Mapping File contains metadata for samples
	mapping_file=/scratch/ps163/Dr_Carolina/Project_Impact/metadata/MappingFile_mangue.csv
...
###heirarchial
	...
	#Mapping File contains metadata for samples
	mapping_file=/scratch/ps163/Dr_Carolina/Project_Impact_v2/MappingFile_Impact.csv
